...
var domainProperty = function(axis) {
  ...
  return Ember.computed(dataKey + '.[]', minKey, maxKey, scaleTypeKey, logMinKey, function(){
...
export default Ember.Component.extend({
  ...
  */
  dataExtents: Ember.computed('graphics.[].data', function(){
  ...
  */
  ...
  /**
    ...
    @readonly
  */
  xUniqueData: Ember.computed('graphics.[].mappedData', function(){
    var graphics = this.get('graphics');
  ...
  /**
    ...
    @readonly
  */
  yUniqueData: Ember.computed('graphics.[].mappedData', function(){
    var graphics = this.get('graphics');
    var uniq = graphics.reduce((uniq, graphic) => {
      return graphic.get('mappedData').reduce((uniq, d) => {
